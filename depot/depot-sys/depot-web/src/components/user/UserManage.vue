<template>
  <div>
  <div style="background: white;width: 100%;height: 830px;padding: 5px;float: right;border-radius: 10px;border: 1px solid black;overflow: auto;box-sizing: border-box">
    ...
    <div style="margin-bottom: 5px;width: 80%">
      <el-input v-model="name"
                ...
                style="width: 300px;left:35%"></el-input>
      <el-select v-model="sex"
                 style="left:45%;width: 300px"
      ...
      <el-button type="primary"
                 style="margin-left: 465px;margin-top: 10px;width: 100px;"
                 @click="loadPost">查询</el-button>
      <el-button type="success" @click="reset" style="margin-left: 220px;width: 100px;">重置</el-button>
      <el-button type="primary" @click="add" style="margin-left: 220px;width: 100px;">新增</el-button>
    </div>
